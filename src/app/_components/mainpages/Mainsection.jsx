  ...
  return (
    <div className=" h-fit  w-full">
      ...
      >
        ...
        <div
          onClick={handleNext}
          className="absolute shadow-[0px_25px_75px_0px_rgba(6,7,20,0.1)] backdrop-blur-[7px] right-40 top-[30%] w-[120px] bg-[rgba(38,40,64,0.8)] rounded-full flex-center h-[120px] cursor-pointer"
        >
